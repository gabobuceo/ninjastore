...
CREATE TABLE NOTIFICACION(
	...
	BAJA			BOOLEAN			DEFAULT 0,
	PRIMARY KEY		(ID),
	CHECK			(TIPO='PREGUNTA' AND TIPO='RESPUESTA' AND TIPO='COMPRA' AND TIPO='VENTA' AND TIPO='CONFIRMADOC' AND TIPO='CALIFICACIONC' AND TIPO='CONFIRMADOV' AND TIPO='CALIFICACIONV' AND TIPO='PERMUTA' AND TIPO='BANEADO' AND TIPO='FINALIZADO'),
	INDEX			(USUARIO)
);
...
SELECT PREGUNTA.ID AS IDPREGUNTA,PREGUNTA.IDPUBLICACION,PREGUNTA.MENSAJE,PREGUNTA.FECHAM,PREGUNTA.RESPUESTA,PREGUNTA.FECHAR,USUARIO.ID AS IDCOMPRADOR,USUARIO.CEDULA AS CICOMPRADOR,USUARIO.USUARIO AS USUCOMPRADOR,USUARIO2.ID AS IDVENDEDOR,USUARIO2.CEDULA AS CIVENDEDOR,USUARIO2.USUARIO AS USUVENDEDOR
