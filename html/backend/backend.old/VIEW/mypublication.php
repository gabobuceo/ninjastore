			...
			<div class="navbar navbar-default" role="navigation">
				...
				<div class="navbar-collapse collapse sidebar-navbar-collapse">
					<ul class="nav navbar-nav" id="sidenav01">
						...
						<li><a href="searchprofile.php"><i class="fa fa-id-card" aria-hidden="true"></i>Busqueda Perfiles</a></li>
						<li class="active"><a href="mypublication.php"><i class="fa fa-shopping-bag" aria-hidden="true"></i> Publicaciones</a></li>
			...
			<div class="col-md-7">
				...
				<div class="single-page main-grid-border">
					<div class="leftcpanel">
						<h4>Sin Confirmar</h4>
						<div class="table-responsive">
							<table id="listconfirm" class="table table-striped responsive table-bordered" cellspacing="0" width="100%">
								<thead>
									<tr>
										<th>Name</th>
										<th>Position</th>
				...
				<div class="single-page main-grid-border">
					<div class="leftcpanel">
						<h4>Cerradas</h4>
						<div class="table-responsive">
							<table id="listclosed" class="table table-striped responsive table-bordered" cellspacing="0" width="100%">
								<thead>
									<tr>
										<th>Name</th>
										<th>Position</th>
